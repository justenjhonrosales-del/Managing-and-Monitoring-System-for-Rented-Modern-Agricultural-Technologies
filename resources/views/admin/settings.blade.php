...
<body>
    <div class="settings-container">
        ...
        <div class="main-content">
            ...
            <div id="equipment-section" class="content-section active">
                <div class="section-header">
                    <div class="section-title">
                        <i class="fas fa-tools"></i> Equipment Management
                    </div>
                    <div class="section-subtitle">Configure equipment availability and maintenance status</div>
                </div>
                ...
                <form action="{{ route('settings.equipment.update') }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="toggle-group">
                        <div class="toggle-label">
                            <div class="toggle-label-title">Auto-Mark Unavailable When Rented</div>
                            <div class="toggle-label-desc">Automatically set equipment as unavailable when rented out</div>
                        </div>
                        <div class="toggle-switch" id="autoMarkToggle" data-setting="auto_mark_unavailable" onclick="toggleSetting(this, '{{ route('settings.toggle.automark') }}')">
                        </div>
                    </div>

                    <div class="form-section-title">Equipment Status Management</div>
                            ...
                            <div class="equipment-item">
                                <div class="equipment-header">
                                    <div>
                                        ...
                                        <div class="setting-value" style="margin-bottom: 0;">
                                            <span class="status-badge status-{{ str_replace('_', '-', $equipment->status) }}">
                                ...
                                <div class="equipment-controls">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <select name="equipment_status[{{ $equipment->id }}]">
                                    ...
                                    <div class="form-group">
                                        <label>Notes</label>
                                        <textarea name="equipment_notes[{{ $equipment->id }}]" rows="2" style="resize: vertical;">{{ $equipment->notes }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="button-group">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Save Equipment Settings
                        </button>
                    </div>
                </form>
            </div>
